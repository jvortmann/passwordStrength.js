...
limit:90}],rates:[function(a){return 4*a.length},function(a){return c(a,/\d/,4)},function(a){return b(a,/[a-z]/,1)},function(a){return b(a,/[A-Z]/,1)},function(a){return c(a,/\W/,6)}],validations:[{message:"Too short",status:"too_short",valid:function(a){return 4<a.length}}]}}(),f=function(c){var b=c.limits.reverse(function(a,b){return a.limit-b.limit}),a=function(a,b,c){var e=document.createElement("div"),d=document.createElement("span");d.className="message";d.innerHTML=a;e.appendChild(d);a=document.createElement("div");
a.className="bar";d=document.createElement("span");d.className="meter";var h,f="";for(h=0;h<c;h+=1)f=f.concat("-");d.innerHTML=f;h=document.createElement("span");h.className="score";h.innerHTML=c;a.appendChild(h);a.appendChild(d);c=a;a=document.createElement("div");a.id="password_strength";a.classList.add(b);a.appendChild(e);a.appendChild(c);return a},e=function(){return a(b[b.length-1].message,b[b.length-1].status,0)},d=function(a){document.getElementById("password_strength").parentNode.replaceChild(a,
